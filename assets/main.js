...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-down', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('form.style1', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'zoom-out', speed: 1000, intensity: 10, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
